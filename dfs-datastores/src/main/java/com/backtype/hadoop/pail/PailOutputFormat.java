...
public class  PailOutputFormat extends FileOutputFormat<Text, BytesWritable> {
    ...
    public RecordWriter<Text, BytesWritable> getRecordWriter(FileSystem ignored, JobConf jc, String uniqueIdForPath, Progressable p) throws IOException {
        return new PailRecordWriter(jc, uniqueIdForPath, p);
    }
